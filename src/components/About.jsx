...
function About() {
  const handleDownload = () => {
    const resumeUrl = 'Christian resume FuD.pdf](https://github.com/hakichris/python_project/files/12629338/Christian.resume.FuD.pd'; // Replace with your resume file URL
